...
describe('Service Tests', () => {
  describe('Rapport Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Rapport(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Rapport', async () => {
        const returnedFromService = Object.assign(
          {
            month: 'BBBBBB',
            meteo: 'BBBBBB',
      ...
      it('should return a list of Rapport', async () => {
        const returnedFromService = Object.assign(
          {
            month: 'BBBBBB',
            meteo: 'BBBBBB',
      ...
      it('should delete a Rapport', async () => {
